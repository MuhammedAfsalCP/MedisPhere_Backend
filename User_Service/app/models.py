...
class UserProfile(AbstractBaseUser, PermissionsMixin):
    ...
    medical_report = models.ImageField(upload_to='medicalreport',null=True, blank=True,  default=None)
    ...
    department = models.CharField(
        max_length=20, choices=DepartmentChoices.choices,
        help_text="Select the doctor's department",
        null=True, blank=True
       
    )
    years_of_experiance = models.PositiveIntegerField(null=True, blank=True, default=None)
    license_number = models.CharField(max_length=20, null=True, blank=True, default=None)
    license_photo = models.ImageField(upload_to='licensephoto', null=True, blank=True, default=None)
